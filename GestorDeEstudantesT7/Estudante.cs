...
namespace GestorDeEstudantesT7
{
    internal class Estudante
    {
        ...
        {
            MySqlCommand comando = new MySqlCommand("UPDATE `estudantes` SET\r\n`nome`= @nome,`sobrenome`=@sobrenome,`nascimento`=@nascimento,`genero`=@genero,`telefone`=@telefone,`endereco`=@endereco,`foto`=@foto WHERE `id` = @id"), meuBancoDeDados.getConexao);
